...
//   // useEffect(() => {
//   //   const loadSong = async () => {
//   //     // 🧠 Nếu ở chế độ offline
//   //     if (fromDownloadedPage === "true" && song) {
//   //       try {
//   //         const localSong = JSON.parse(decodeURIComponent(song));
//   //         const path = getLocalSongPath(localSong.id); // Lấy đường dẫn local từ getLocalSongPath
//   //         const fileInfo = await FileSystem.getInfoAsync(path); // Kiểm tra sự tồn tại của file

//   //         if (fileInfo.exists) {
//   //           setSong({
//   //             ...localSong,
//   //             preview_url: path, // Đặt preview_url là đường dẫn local
//   //           });
//   //           setIsOffline(true);
//   //           setLoading(false);
//   //         } else {
//   //           setLoading(false);
//   //           console.error("File không tồn tại ở đường dẫn:", path);
//   //         }
//   //       } catch (e) {
//   //         console.error("❌ Lỗi giải mã songParam:", e);
//   //         setLoading(false);
...
//     } else {
//       // Nếu đang phát bài khác, hoặc phát lại từ đầu
